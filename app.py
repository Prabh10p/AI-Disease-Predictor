...
import pandas as pd
from src.Pipeline.predict_pipeline import Modelfeatures, PredictPipeline
...
SYMPTOM_FEATURES = [  # already-cleaned version of features
    ...
    'dischromic__patches', 'watering_from_eyes', 'increased_appetite', 'polyuria',
    ...
    'distention_of_abdomen', 'history_of_alcohol_consumption', 'fluid_overload1',
